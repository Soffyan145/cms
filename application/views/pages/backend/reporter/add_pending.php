    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="<?php echo site_url('admin/data_news_pending/add_action') ?>" enctype="multipart/form-data">
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Title</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="title" class="form-control">
                                <input type="hidden" name="id_user" class="form-control" value="<?php echo $user['nama'] ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <textarea name="body" id="" cols="81" rows="10"></textarea>
                            </div>
                        </div>
